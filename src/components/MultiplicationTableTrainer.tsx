...
import styles from './MultiplicationTableTrainer.module.css';
...
const MultiplicationTableTrainer = () => {
      ...
      <div className={styles.trainerContainer}>
        <div className={styles.headerSection}>
          ...
          <div className={styles.titleSection}>
            <h2 className={styles.trainerTitle}>Тренажер «Таблица умножения»</h2>
...
export default MultiplicationTableTrainer;
