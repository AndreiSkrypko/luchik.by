      ...
      <main>
        <div className={styles.courseMain}>
          <div className={styles.titleSection}>
            ...
            <h1 className={styles.pageTitle}>Робототехника для подростков 10–17 лет</h1>
            <p className={styles.pageDescription}>Продвинутые проекты — датчики, микроконтроллеры, программирование, Лида</p>
          </div>

          <div className={styles.topGrid}>
            <div className={styles.leftColumn}>
              <div className={styles.heroImage}>
                <img src={robotics10_17Img} alt="Робототехника для подростков 10–17 лет в Лиде, детский центр Лучик" loading="lazy" decoding="async" />
              </div>
              ...
              <CoursePriceGallery courseId="robotics-10-17" />
