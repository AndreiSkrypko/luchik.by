...
export const seoConfig: Record<string, SeoConfig> = {
  ...
  '/age/5-10': {
    ...
    description: 'Программы для детей 5-10 лет в Лиде: годовая и экспресс подготовка к школе, шахматы, скорочтение, ментальная арифметика, программирование, робототехника, английский. Детский центр Лучик.',
    keywords: `${baseKeywords}, занятия 5-10 лет Лида, подготовка к школе Лида, программирование для детей Лида, робототехника дети Лида`,
